...
#PBS -o /mnt/lustre/users/fkebaso/hippo/hcamelina_male/results/busco/gene_quality/spades/braker.out
#PBS -e /mnt/lustre/users/fkebaso/hippo/hcamelina_male/results/busco/gene_quality/spades/braker.err
#PBS -m abe
...
results="${basedir}/results/busco/gene_quality/spades"
predicted_genes=("${basedir}/results/braker/spades_restart/hcamelina_male_spades.aa")
