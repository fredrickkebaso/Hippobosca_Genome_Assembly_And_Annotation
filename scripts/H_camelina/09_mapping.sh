...
#PBS -o /mnt/lustre/users/fkebaso/hippo/hcamelina_male/results/mapping_2/mapping_stats.out   
#PBS -e /mnt/lustre/users/fkebaso/hippo/hcamelina_male/results/mapping_2/mapping_stats.err    
#PBS -m abe                                                              
...
# Define input files 
genome_files=("${basedir}/repeatmasker/spades/hcamelina_male_spades_genome.fa")
num_threads=56

# Raw reads
forward_read="${basedir}/spades/corrected/hcamelina_male_unclassified_reads_1.00.0_0.cor.fastq.gz" # Path to the forward read file
reverse_read="${basedir}/spades/corrected/hcamelina_male_unclassified_reads_2.00.0_0.cor.fastq.gz" # Path to the reverse read file
