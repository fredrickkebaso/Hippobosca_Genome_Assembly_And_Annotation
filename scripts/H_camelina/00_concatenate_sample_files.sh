...
forward_reads=(${basedir}/data/raw_reads/*S4-Hcamelina-M2_S4_*_R1_001.fastq.gz)
reverse_reads=(${basedir}/data/raw_reads/*S4-Hcamelina-M2_S4_*_R2_001.fastq.gz)
results="${basedir}/hcamelina_male/results/data/merged_raw_reads"
forward_output="${results}/S4-Hcamelina-M2.R1.fastq.gz"
reverse_output="${results}/S4-Hcamelina-M2.R2.fastq.gz"
