...
#PBS -o /mnt/lustre/users/fkebaso/hippo/hcamelina_male/results/pilon/velvet/pilon.out
#PBS -e /mnt/lustre/users/fkebaso/hippo/hcamelina_male/results/pilon/velvet/pilon.err
#PBS -m abe
#PBS -M fredrickkebaso@gmail.com
#PBS -N pilon_velvet_hc_f
...
genome="${basedir}/velvet/hcamelina_f_velvet_genome_filtered_assembly_renamed.fa"
bam_file="${basedir}/mapping/hcamelina_f_velvet_genome_filtered_assembly_renamed_mapped.sorted.bam"
