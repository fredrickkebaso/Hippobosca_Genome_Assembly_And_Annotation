...
#PBS -o /mnt/lustre/users/fkebaso/hippo/hvariegata_female/results/braker/soapdenovo2/braker.out
#PBS -e /mnt/lustre/users/fkebaso/hippo/hvariegata_female/results/braker/soapdenovo2/braker.err
#PBS -m abe
#PBS -M fredrickkebaso@gmail.com
#PBS -N braker_soapdenovo2_hv_f
...
results="${basedir}/results/braker/soapdenovo2"
genome="${basedir}/results/repeatmasker/soapdenovo2/hv_f_genome_soapdenovo2_genome.fa"
