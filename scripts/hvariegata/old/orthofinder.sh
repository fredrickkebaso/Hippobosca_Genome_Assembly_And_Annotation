...
#PBS -o /mnt/lustre/users/fkebaso/hippo/hvariegata_female/results/orthofinder/spades/orthofinder.out
#PBS -e /mnt/lustre/users/fkebaso/hippo/hvariegata_female/results/orthofinder/spades/orthofinder.err
#PBS -m abe
...
prot_sequences="${basedir}/data/databases/close_sp_genome_databases/orthofinder_targeted_db"
results="${basedir}/hvariegata_female/results/orthofinder/orthofinder_targeted_chemosensory"
...
# env_name="/home/fkebaso/miniconda3/envs/orthofinder"
