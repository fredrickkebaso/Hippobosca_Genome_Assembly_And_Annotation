...
#PBS -o /mnt/lustre/users/fkebaso/hippo/hvariegata_female/results/repeatmodeler/spades/spades.out
#PBS -e /mnt/lustre/users/fkebaso/hippo/hvariegata_female/results/repeatmodeler/spades/spades.err
#PBS -m abe
...
genome="${basedir}/pilon/spades/hvariegata_f_spades_genome_filtered_assembly_renamed.fa"
