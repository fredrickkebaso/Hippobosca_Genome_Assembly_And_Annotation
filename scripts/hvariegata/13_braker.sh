...
#PBS -o /mnt/lustre/users/fkebaso/hippo/hvariegata_female/results/braker/spades/braker.out
#PBS -e /mnt/lustre/users/fkebaso/hippo/hvariegata_female/results/braker/spades/braker.err
#PBS -m abe
#PBS -M fredrickkebaso@gmail.com
#PBS -N braker_spades_hv
...
genome="${basedir}/results/repeatmasker/spades/hvariegata_f_spades_genome_filtered_assembly_renamed.fa.masked"
protein_file="${basedir}/results/braker/protein_db/Dme_glossina_proteins.fa"
threads=48
mincontig=100
