...
echo Computing hcamelina_m_genome_stats using BUSCO. Recommended version 5.4.4....

echo Found `busco --version` proceeding with metric computation...

busco \
--in results/repeatmasker/hcamelina_m_genome.fa.masked \
...
cp results/busco_stats/genome_stats/short_summary.specific.arthropoda_odb10.genome_stats.txt results/busco_plots/hcamelina_m_genome
