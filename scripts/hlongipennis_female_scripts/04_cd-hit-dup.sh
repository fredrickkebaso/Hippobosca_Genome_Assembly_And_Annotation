...
cd-hit-dup \
-i results/clean_reads/S2-Hlongipenis-F.R1_val_1.fq \
-o results/de_duplicated_reads/S2-Hlongipenis-F.R1.dedup.fq \
-i2 results/clean_reads/S2-Hlongipenis-F.R2_val_2.fq \
-o2 results/de_duplicated_reads/S2-Hlongipenis-F.R2.dedup.fq \
