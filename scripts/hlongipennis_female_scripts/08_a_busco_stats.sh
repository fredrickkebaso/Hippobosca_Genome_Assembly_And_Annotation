...
echo Computing hlongipennis_f_genome_stats using BUSCO. Recommended version 5.4.4....
...
cp results/busco_stats/genome_stats/short_summary.specific.arthropoda_odb10.genome_stats.txt results/busco_plots/hlongipennis_f_genome
