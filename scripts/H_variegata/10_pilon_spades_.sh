...
#PBS -o /mnt/lustre/users/fkebaso/hippo/hvariegata_female/results/pilon/spades/pilon.out
#PBS -e /mnt/lustre/users/fkebaso/hippo/hvariegata_female/results/pilon/spades/pilon.err
#PBS -m abe
#PBS -M fredrickkebaso@gmail.com
#PBS -N pilon_spades_hv_f
...
genome="${basedir}/spades/hvariegata_f_spades_genome_filtered_assembly_renamed.fa"
bam_file="${basedir}/mapping/hvariegata_f_spades_genome_filtered_assembly_renamed_mapped.sorted.bam"
...
java -Xmx240g -jar /home/fkebaso/miniconda3/envs/pilon/share/pilon-1.24-0/pilon.jar \
--genome "${genome}" \
--frags "${bam_file}" \
--fix "bases" \
--changes \
