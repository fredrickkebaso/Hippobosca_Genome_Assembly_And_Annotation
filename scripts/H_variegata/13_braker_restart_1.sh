...
#PBS -o /mnt/lustre/users/fkebaso/hippo/hvariegata_female/results/braker/velvet/braker_restart.out
#PBS -e /mnt/lustre/users/fkebaso/hippo/hvariegata_female/results/braker/velvet/braker_restart.err
#PBS -m abe
#PBS -M fredrickkebaso@gmail.com
#PBS -N restart_braker_velvet_hc_m
...
new_work_dir="${basedir}/results/braker/velvet_restart"

# Set the directory for the previous run
oldDir="${basedir}/results/braker/velvet"
