...
#PBS -o /mnt/lustre/users/fkebaso/hippo/hvariegata_female/results/clean_reads/clean.out
#PBS -e /mnt/lustre/users/fkebaso/hippo/hvariegata_female/results/clean_reads/clean.err
#PBS -m abe
...
# if [ -d "${results}" ]; then
#     rm -r "${results}"
#     rm -r ${basedir}/quality_reports/{fastqc_clean_reads,multiqc_clean_reads}
# fi
