...
#PBS -o /mnt/lustre/users/fkebaso/hippo/hvariegata_female/resultsbusco/genome_quality/genome.out
#PBS -e /mnt/lustre/users/fkebaso/hippo/hvariegata_female/resultsbusco/genome_quality/genome.err
#PBS -m abe
...
cp "${basedir}/repeatmasker/spades_pilon/hv_f_spades_genome_filtered_assembly_renamed_pilon/hvariegata_f_spades_genome.fa" \
   "${basedir}/repeatmasker/spades_pilon/hvariegata_f_spades_piloned_genome.fa"

#Initalizing variables
results="${basedir}/busco/genome_quality"
genomes=("${basedir}/repeatmasker/spades_pilon/hvariegata_f_spades_piloned_genome.fa")
mode="genome"
threads=24
